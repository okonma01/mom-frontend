...
const Footer = () => {
  return (
    <a href="https://github.com/okonma01/mom-frontend" target="_blank" rel="noopener noreferrer" className="github-corner" aria-label="View source on GitHub">
      <svg width="60" height="60" viewBox="0 0 250 250" className="github-svg" aria-hidden="true">
